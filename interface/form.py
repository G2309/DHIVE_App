...
def new_user_form(parent, colors):
    ...
    message_label.grid(row=6, column=0, columnspan=2, padx=10, pady=10)
    ...
    def submit_user():
        ...
        if verify_user(first_name, carnet):
            ...
            # Intento de agregar nuevo usuario
    ...
    # Creación de etiquetas y campos de entrada para el formulario
    ...
    # Botón para agregar usuario que llama a submit_user
